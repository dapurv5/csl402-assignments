...
public class ChainCode4 {
  ...
  public ChainCode4(BufferedImage image){
    this.image  = image;
  ...
  private String f(int x, int y) {
    ...
    Dimension secondCell = getNextCell4(x, y);
   ...
   * 567 
   */
  private Dimension getNextCell4(int x, int y){
    int startDirection = (direction + 3)%4;
    int i = 0;
    Dimension d = null;
    while(i<3){
